...
<body>
<div id="wrapper">
<div id="header"><img src="gfx/logo.gif" alt="The Family Website Logo" width="800" height="150" /></div>
<div id="date"><script language="JavaScript" type="text/javascript" src="http://www.whizkidonline.com/forums/date.js"></script></div>
<div id="content">If you want to contact a person of the family fill out the form and we will get back to you. If there is a problem with the site also fill out the form and we will fix the problem. <br />
  <br />
  <div align="center"><form action="http://www.whizkidonline.com/famweb/contact/mailer.php" method="post" name="form1" id="form1" style="margin:0px; font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px; width:300px;" onsubmit="MM_validateForm('from','','RisEmail','subject','','R','verif_box','','R','message','','R');return document.MM_returnValue">
...
<img src="http://www.whizkidonline.com/famweb/contact/verificationimage.php?<?php echo rand(0,9999);?>" alt="verification image, type it in the box" width="50" height="24" align="absbottom" /><br />
<br />
...
document.write(' The Family Website - All Rights Reserved.');
//-->
...
document.write(' 2005 - ');
document.write(new Date().getFullYear());
document.write(' Whizkid Online - All Rights Reserved.');
//-->
</script></div>
</div>
